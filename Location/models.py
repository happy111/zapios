...
class StateMaster(models.Model):
    ...
    country = models.ForeignKey(
        CountryMaster,
    	related_name='state_master_state',
        on_delete=models.CASCADE,
    	null=True,
        verbose_name='Country',
        limit_choices_to={'active_status': '1'})
    ...
    class Meta:
        ...
        verbose_name = '  State/Prefecture'
        verbose_name_plural = '  State/Prefecture'
        ordering = ['state']
